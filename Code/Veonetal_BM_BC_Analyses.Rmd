...
###Read in data file###
```{r}
BCI30km <- read.csv("./MallBCI_20192021_30km.csv", header = TRUE)
BCILocTry <- read.csv("./MallBCI_20192021_30km.csv", header = TRUE)
library(ggplot2)
library(ggfortify) 
library(MASS)
library(ggthemes)
...
```{r}
# Load data
my_CorBCI <- BCI30km[, c(19,21,26,27,28,30,31,32,33,36)]
